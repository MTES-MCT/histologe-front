...
session_start();
if(isset($_GET['sg'])) {
  $_SESSION['redirect']='detailsSign.php?id='.$_GET['sg'];
}
    ...
    <main role="main" class="col-sm-9 ml-sm-auto col-md-10 pt-3">
      ...
      <section class="row text-center placeholders">
        <div class="col-6 col-sm-3 placeholder">
          ...
          <div class="text-muted">Entrer vos identifiants Histologe</div>
          <form class="form-inline mt-2 mt-md-0" action="ident.php" method="post">
             <input class="form-control mr-sm-2" type="text" placeholder="Utilisateur" aria-label="Utilisateur" name="user" id="user">
            <input class="form-control mr-sm-2" type="password" placeholder="Password" aria-label="Password" name="passw" id="passw">
