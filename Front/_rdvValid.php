    ...
    <div class="row">
      ...
      <div class="col-md-12 ft ">
        <div class="mx-auto text-center col-md-12 " id="tit1">
            ...
            <h1 class="text-white w-100 display-6"><br><br>Demande de visite à distance enregistrée !</h1><br><br>
            <p class="lead">Une invitation va vous être rapidement envoyée. <br>
          L'équipe Histologe vous remercie.b
            </p>
            <br><br><br>
          </div>
          <div class="mx-auto text-center col-md-12" id="tit2">
            ...
            <h1 class="text-dark w-100 display-6"><br><br>Demande de visite à distance enregistrée !</h1><br><br>
            <p class="lead text-dark">Une invitation va vous être rapidement envoyée. <br>
