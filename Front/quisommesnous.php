 ...
 <H1>Qui sommes-nous ?</h1>
      ...
      <div class="col-md-8">
        Histologe est un service public permettant de faciliter la détection, le signalement, l’évaluation, l’envoi d’alertes et le suivi des logements pour accélérer la prise en charge du “mal logement”.
            <br>
            <b>Histologe est une start-up d’Etat portée par le dispositif Beta.gouv.fr</b>. Cet outil est actuellement expérimenté par la communauté d’agglomération Pau Béarn Pyrénées. Les signalements peuvent être enregistrés uniquement sur son territoire administratif.
            <br><br>
            ...
            <br><br><br>
            Notre partenaire Palois :<a href="https://www.pau.fr/article/maison-de-lhabitat-et-du-projet-urbain" target="_new"> La Maison de l'Habitat et du Projet Urbain <img src="img/mdh.jpg"></a>
            <br><br>
            Nos partenaires :<br>
            <div class="text-center"><img src="img/unis.png">&nbsp;<img src="img/dihal.png"><br><br>
            <img src="img/infoe.png">&nbsp;<img src="img/anil.png">&nbsp;<img src="img/caf.png">&nbsp;<img src="img/compagnons.png"></div>
            <br><br><br>
        </div>
        <div class="col-md-2">
        </div>
